    ...
    <div className="relative">
      ...
      <motion.button
        ...
        className={`
          ...
          ${open ? "absolute top-[13px] left-[740px]" : "fixed top-[120px] left-[20px]"}
        `}
      >
          ...
          <>
            ...
            >
              <div className="flex h-full">
                ...
                {/* Left */}
                <motion.div
                  className="w-[60%] p-6 border-r bg-white rounded-4xl border-black flex flex-col justify-between"
                ...
                >
                  ...
                  <button
                    onClick={handleSend}
                    disabled={loading}
                    className="mt-4 ml-36 bg-black text-white py-2 rounded-xl hover:bg-gray-800 text-base disabled:opacity-60"
                  >
                ...
                {/* Right */}
                <motion.div
                  className="w-[40%] bg-black text-white p-8 flex flex-col text-[15px]"
                ...
                >
                  ...
                  <a href="mailto:castroconi101@gmail.com" className="underline text-xl">
                    Email
                  </a>

                  <a href="tel:+14374451436" className="underline text-xl mb-3">
                    Phone
                  </a>
